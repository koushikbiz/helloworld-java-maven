...
public class EMScope_Trade_Details_Rejected  {
    public static void main(String[] args) {
    	System.out.println("######################################################################");
		System.out.println("EMSCOPE AUTOMATION TEST CASE 6\n");
		System.out.println("THIS TEST CASE VERIFIES CONTENT OF TRADE DETAILS PAGE FOR A REJECTED TRADE OF A GIVEN MARKET ORDER\n");
        ...
        // In the Trades table, click on the first rejected trade
        WebElement orderdetailslink = driver.findElement(By.xpath("//body/div[1]/div/div[2]/div[2]/div[10]/div/div/div[1]/div/div/div[4]/table/tbody/tr[2]/td[1]/a[1]"));
        ...
        if (rate.equals("1.08808")) System.out.println ("Trade Rate " + rate + " is correct");
        ...
        if (baseamount.equals("500,000.00")) System.out.println ("Base Amount " + baseamount + " is correct");
        ...
        if (termamount.equals("544,040.00")) System.out.println ("Term Amount " + termamount + " is correct");
        ...
        if (tradeid.equals("FXI905425276C")) System.out.println ("Trade ID " + tradeid + " is correct");
        ...
        if (counterparty.equals("BOAP")) System.out.println ("Counterparty " + counterparty + " is correct");
        ...
        if (spotrate.equals("1.08808")) System.out.println ("Spot Rate " + spotrate + " is correct");
        ...
        if (tradestatus.equals("Rejected")) System.out.println ("Trade Status " + tradestatus + " is correct");
        ...
        if (usdamount.equals("500,000.00")) System.out.println ("USD Amount " + usdamount + " is correct");
        ...
        if (matchedrate.equals("1.08808")) System.out.println ("Matched Rate " + matchedrate + " is correct");
        ...
        if (cptyaccount.equals("BOAP")) System.out.println ("Counterpaty Account " + cptyaccount + " is correct");
        ...
        if (stream.equals("CITIP")) System.out.println ("Stream " + stream + " is correct");
        ...
        if (makerorg.equals("BOAP")) System.out.println ("Maker Org " + makerorg + " is correct");
        ...
        if (mkrrefid.equals("FXI905425276C")) System.out.println ("Maker Ref ID " + mkrrefid + " is correct");
        ...
        if (extdealid.equals("FXI905425276C")) System.out.println ("External Deal ID " + extdealid + " is correct");
        ...
        if (cptyFI.equals("BOAP")) System.out.println ("Counter Party(FI) " + cptyFI + " is correct");
        ...
        if (comment.equals("Asked price is no longer available.")) System.out.println ("Comment " + comment + " is correct");
        ...
        String provrateused = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[12]/td[5]/strong")).getText();
        if (provrateused.equals("1.08809")) System.out.println ("Provier Rate Used for Trade " + provrateused + " is highlighted");
                	        
        String provused = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[12]/td[2]")).getText();
        if (provused.equals("P491")) System.out.println ("Provier Used for Trade " + provused + " is highlighted");
                
        String usedratetimestmp = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[12]/td[1]")).getText();
        ...
        if (event2.equals("RateReceivedByAdapter (1.08808/1.08821)")) System.out.println ("Event2:: " + event2 + " is correct");
        ...
        if (event15.equals("TradeRejectReceivedFromProvider")) System.out.println ("Event15:: " + event15 + " is correct");
        ...
        if (event17.equals("RejectionReceivedByIS")) System.out.println ("Event17:: " + event17 + " is correct");
        ...
        if (guidordmatchedevent.equals("G-605765e-145f0767c5e-BOAP-19678da-BHINYD-F890-1070082")) System.out.println ("GUID for OrderMatchedByServer event:: " + guidordmatchedevent + " is correct");
        ...
        if (ctdealid.equals("FXI905425276")) System.out.println ("Deal ID1 for Covered Trades:: " + ctdealid + " is correct");
        ...
        if (ctccypair.equals("USD/CAD")) System.out.println ("Ccy Pair1 for Covered Trades:: " + ctccypair + " is corerct");
        ...
        if (ctbaseamount.equals("500,000.00")) System.out.println ("Base Amount1 for Covered Trades:: " + ctbaseamount + " is correct");
        ...
        if (cttermamount.equals("544,040.00")) System.out.println ("Term Amount1 for Covered Trades:: " + cttermamount + " is correct");
        ...
        if (ctrate.equals("1.08808")) System.out.println ("Rate1 for Covered Trades:: " + ctrate + " is correct");
        ...
        if (ctstatus.equals("Rejected")) System.out.println ("Status1 for Covered Trades:: " + ctstatus + " is correct");
        else System.out.println ("Status1 for Covered Trades:: " + ctstatus + " is incorrect");
        
        // Validate contents of Covering Trades panel        
        System.out.println("\nPanel Name:" + driver.findElement(By.xpath("//body/div[5]/div[1]")).getText());
        System.out.println("************************");
        
        String column31 = driver.findElement(By.xpath("//body/div[5]/div[2]/table/thead/tr/td[1]")).getText();
        if (column31.equals("Deal ID")) System.out.println ("Column1 Heading:: " + column31 + " is correct");
        else System.out.println ("Column1 Heading:: " + column31 + " is incorrect");
        
        String column32 = driver.findElement(By.xpath("//body/div[5]/div[2]/table/thead/tr/td[2]")).getText();
        if (column32.equals("CCY Pair")) System.out.println ("Column2 Heading:: " + column32 + " is correct");
        else System.out.println ("Column2 Heading:: " + column32 + " is incorrect");
        
        String column33 = driver.findElement(By.xpath("//body/div[5]/div[2]/table/thead/tr/td[3]")).getText();
        if (column33.equals("Execution Time")) System.out.println ("Column3 Heading:: " + column33 + " is correct");
        else System.out.println ("Column3 Heading:: " + column33 + " is incorrect");
        
        String column34 = driver.findElement(By.xpath("//body/div[5]/div[2]/table/thead/tr/td[4]")).getText();
        if (column34.equals("Base Amt")) System.out.println ("Column4 Heading:: " + column34 + " is correct");
        else System.out.println ("Column4 Heading:: " + column34 + " is incorrect");
        
        String column35 = driver.findElement(By.xpath("//body/div[5]/div[2]/table/thead/tr/td[5]")).getText();
        if (column35.equals("Term Amt")) System.out.println ("Column5 Heading:: " + column35 + " is correct");
        else System.out.println ("Column5 Heading:: " + column35 + " is incorrect");
        
        String column36 = driver.findElement(By.xpath("//body/div[5]/div[2]/table/thead/tr/td[6]")).getText();
        if (column36.equals("Rate")) System.out.println ("Column6 Heading:: " + column36 + " is correct");
        else System.out.println ("Column6 Heading:: " + column36 + " is incorrect");
        
        String column37 = driver.findElement(By.xpath("//body/div[5]/div[2]/table/thead/tr/td[7]")).getText();
        if (column37.equals("Buy/Sell")) System.out.println ("Column7 Heading:: " + column37 + " is correct");
        else System.out.println ("Column7 Heading:: " + column37 + " is incorrect");
        
        String column38 = driver.findElement(By.xpath("//body/div[5]/div[2]/table/thead/tr/td[8]")).getText();
        if (column38.equals("Status")) System.out.println ("Column8 Heading:: " + column38 + " is correct");
        else System.out.println ("Column8 Heading:: " + column38 + " is incorrect");
        
        String cgtdealid = driver.findElement(By.xpath("//body/div[5]/div[2]/table/tbody/tr/td[1]")).getText();
        if (cgtdealid.equals("FXI910412236")) System.out.println ("Deal ID1 for Covering Trades:: " + cgtdealid + " is correct");
        else System.out.println ("Deal ID1 for Covering Trades:: " + cgtdealid + " is incorrect");
        
        String cgtccypair = driver.findElement(By.xpath("//body/div[5]/div[2]/table/tbody/tr/td[2]")).getText();
        if (cgtccypair.equals("USD/CAD")) System.out.println ("Ccy Pair1 for Covering Trades:: " + cgtccypair + " is correct");
        else System.out.println ("Ccy Pair1 for Covering Trades:: " + cgtccypair + " is incorrect");
        
        String cgtexectime = driver.findElement(By.xpath("//body/div[5]/div[2]/table/tbody/tr/td[3]")).getText();
        if (cgtexectime.equals("2014-05-12 18:14:30.511")) System.out.println ("Execution Timestamp1 for Covering Trades:: " + cgtexectime + " is correct");
        else System.out.println ("Execution Timestamp1 for Covering Trades:: " + cgtexectime + " is incorrect");
        
        String cgtbaseamount = driver.findElement(By.xpath("//body/div[5]/div[2]/table/tbody/tr/td[4]")).getText();
        if (cgtbaseamount.equals("500,000.00")) System.out.println ("Base Amount1 for Covering Trades:: " + cgtbaseamount + " is correct");
        else System.out.println ("Base Amount1 for Covering Trades:: " + cgtbaseamount + " is incorrect");
        
        String cgttermamount = driver.findElement(By.xpath("//body/div[5]/div[2]/table/tbody/tr/td[5]")).getText();
        if (cgttermamount.equals("544,045.00")) System.out.println ("Term Amount1 for Covering Trades:: " + cgttermamount + " is correct");
        else System.out.println ("Term Amount1 for Covering Trades:: " + cgttermamount + " is incorrect");
        
        String cgtrate = driver.findElement(By.xpath("//body/div[5]/div[2]/table/tbody/tr/td[6]")).getText();
        if (cgtrate.equals("1.08809")) System.out.println ("Rate1 for Covering Trades:: " + cgtrate + " is correct");
        else System.out.println ("Rate1 for Covering Trades:: " + cgtrate + " is incorrect");
        
        String cgtbuysell = driver.findElement(By.xpath("//body/div[5]/div[2]/table/tbody/tr/td[7]")).getText();
        if (cgtbuysell.equals("Sell")) System.out.println ("Buy/Sell1 for Covering Trades:: " + cgtbuysell + " is correct");
        else System.out.println ("Buy/Sell1 for Covering Trades:: " + cgtbuysell + " is incorrect");
        
        String cgtstatus = driver.findElement(By.xpath("//body/div[5]/div[2]/table/tbody/tr/td[8]")).getText();
        if (cgtstatus.equals("Rejected")) System.out.println ("Status1 for Covering Trades:: " + cgtstatus + " is correct");
        else System.out.println ("Status1 for Covering Trades:: " + cgtstatus + " is incorrect");
