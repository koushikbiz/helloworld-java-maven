...
public class EMScope_Landscape_LMT_TKR {

	public static void main(String[] args) {
        System.out.println("######################################################################");
		System.out.println("EMSCOPE AUTOMATION TEST CASE 7\n");
		System.out.println("THIS TEST CASE VERIFIES CONTENT OF EMSCOPE TAB FOR EUR/USD::SUCD::LIMIT::TAKER::9 MINUTES INTERVAL::CITI-Integral1 COMBINATION\n");
        ...
        if (zoomcharttimestamps.startsWith("05/26 01:21") && zoomcharttimestamps.endsWith("5/26 01:30")){
        ...
        for(WebElement option : list4){
            ...
            lastpage.click();            
            WebElement lastorder = driver.findElement(By.xpath("//body/div/div/div/div[4]/div/div/div/div/div/div[4]/table/tbody/tr[7]/td[2]/a"));
            WebElement lasttimestamp = driver.findElement(By.xpath("//body/div/div/div/div[4]/div/div/div/div/div/div[4]/table/tbody/tr[7]/td"));
            
            if(elements4[0].equals("2014-06-30") && elements4[1].equals("01:21:56.342")) {
            	if(elements4[2].equals("652036215") && elements4[3].equals("Sell")) {
            		if(elements4[4].equals("EUR/USD") && elements4[5].equals("1.36457")) {
            			if(elements4[6].equals("1.36457") && elements4[7].equals("100000")) {
            				if(elements4[8].equals("100") && elements4[9].equals("100000")) {
            					if(elements4[10].equals("LIMIT") && elements4[11].startsWith("SUCD")) {
            						if(elements4[66].endsWith("2014-06-30") && elements4[67].equals("01:27:49.766")) {
            							if(elements4[68].equals("652036250") && elements4[69].equals("Sell")) {
            								if(elements4[70].equals("EUR/USD") && elements4[71].equals("1.36447")) {
            									if(elements4[72].equals("1.36447") && elements4[73].equals("10000")) {
            										if(elements4[74].equals("100") && elements4[75].equals("10000")) {
            											if(elements4[76].equals("LIMIT") && elements4[77].startsWith("SUCD")){
            												if(lastorder.getText().equals("652036250") && lasttimestamp.getText().equals("2014-06-30 01:27:49.766")){
        ...
        for(WebElement option : list5){
            ...
            WebElement lasttrade = driver.findElement(By.xpath("//body/div/div/div/div[4]/div/div/div[2]/div/div/div[4]/table/tbody/tr[7]/td[3]/a"));
            WebElement lasttimestamp2 = driver.findElement(By.xpath("//body/div/div/div/div[4]/div/div/div[2]/div/div/div[4]/table/tbody/tr[7]/td"));
            
            if(elements5[0].equals("2014-06-30") && elements5[1].equals("01:21:56.344")) {
            	if(elements5[2].equals("652036215") && elements5[3].equals("FXI1159195633")) {
            		if(elements5[4].equals("Confirmed") && elements5[5].equals("Sell")) {
            			if(elements5[6].equals("DB") && elements5[8].equals("PRD010")) {
            				if(elements5[9].equals("EUR/USD") && elements5[10].equals("1.36457")) {
            					if(elements5[11].equals("SUCD") && elements5[12].equals("FXSpot")) {
            						if(elements5[13].startsWith("Taker") && elements5[78].endsWith("2014-06-30")) {
            							if(elements5[79].equals("01:27:49.768") && elements5[80].equals("652036250")) {
            								if(elements5[81].equals("FXI1159195744") && elements5[82].equals("Confirmed")) {
            									if(elements5[83].equals("Sell") && elements5[84].equals("VTFX")) {
            										if(elements5[86].equals("VFX4") && elements5[87].equals("EUR/USD")) {
            											if(elements5[88].equals("1.36447") && elements5[89].equals("SUCD")){
            												if(elements5[90].equals("FXSpot") && elements5[91].startsWith("Taker")){
            												if(lasttrade.getText().equals("FXI1159195744") && lasttimestamp2.getText().equals("2014-06-30 01:27:49.768")){
        ...
        for(WebElement option : list6){
            ...
            if(elements6[0].equals("2014-06-30") && elements6[1].equals("01:21:01.000")) {
            	if(elements6[2].equals("1.364585") && elements6[3].startsWith("0.325")) {
            		if(elements6[27].endsWith("2014-06-30") && elements6[28].equals("01:21:10.000")) {
            			if(elements6[29].equals("1.364585") && elements6[30].startsWith("0.1")) {
            				if(elements6[35].equals("540")){
            					if(lastbenchmark.getText().equals("1.364425") && lasttimestamp3.getText().equals("2014-06-30 01:30:00.000")) {
        ...
        for(WebElement option : list7){
            ...
            WebElement lasttimestamp4 = driver.findElement(By.xpath("//body/div/div/div/div[4]/div/div/div[4]/div/div/div[4]/table/tbody/tr[3]/td"));
            WebElement lastrateguid = driver.findElement(By.xpath("//body/div/div/div/div[4]/div/div/div[4]/div/div/div[4]/table/tbody/tr[3]/td[7]"));
                                    
            if(elements7[0].equals("2014-06-30") && elements7[1].equals("01:22:44.718")) {
            	if(elements7[2].equals("1.36464") && elements7[3].equals("500000")) {
            		if(elements7[4].equals("1.3646") && elements7[5].equals("500000")) {
            			if(elements7[6].equals("Active") && elements7[7].equals("G-605766d-146ea5df56e-CITIA-628")) {
            				if(elements7[8].startsWith("1") && elements7[9].equals("01:22:44.718")) {
            					if(elements7[10].equals("1.36466") && elements7[11].equals("1000000")) {
            						if(elements7[12].equals("1.36458") && elements7[13].equals("1000000")) {
            							if(elements7[14].equals("Active") && elements7[15].equals("G-605766d-146ea5df56e-CITIA-628")) {
            								if(elements7[16].startsWith("2") && elements7[72].endsWith("2014-06-30")) {
            									if(elements7[73].equals("01:22:44.722") && elements7[74].equals("1.36463")) {
            										if(elements7[75].equals("500000") && elements7[76].equals("1.36459")) {
            											if(elements7[77].equals("500000") && elements7[78].equals("Active")) {
            											if(elements7[79].startsWith("G-605766d-146ea5df572-CITIA-629") && elements7[80].startsWith("1")){
            												if(elements7[85].equals("509")){
            												if(lasttimestamp4.getText().equals("2014-06-30 01:29:16.215") && lastrateguid.getText().equals("G-605766d-146ea63eeb7-CITIA-65e")){
