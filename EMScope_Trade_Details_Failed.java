...
public class EMScope_Trade_Details_Failed  {
    public static void main(String[] args) {
    	System.out.println("######################################################################");
		System.out.println("EMSCOPE AUTOMATION TEST CASE 9\n");
		System.out.println("THIS TEST CASE VERIFIES CONTENT OF TRADE DETAILS PAGE FOR A FAILED TRADE OF A GIVEN LIMIT RANGE ORDER\n");
        ...
        // In the Trades table, click on the first failed trade
        WebElement tradedetailslink = driver.findElement(By.xpath("//body/div[1]/div/div[2]/div[2]/div[10]/div/div/div[1]/div/div/div[4]/table/tbody/tr[1]/td[1]/a[1]"));
        tradedetailslink.click();
        ...
        System.out.println("Panel Name:" + driver.findElement(By.xpath("//body/div[1]/div[1]")).getText());
        System.out.println("************************");
        
        String ccypair = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[1]/td[2]")).getText();
        if (ccypair.equals("EUR/USD")) System.out.println ("Ccy Pair " + ccypair + " is correct");
        else System.out.println ("Ccy Pair " + ccypair + " is incorrect");
        
        String buysell = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[1]/td[4]")).getText();
        ...
        String rate = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[1]/td[6]")).getText();
        if (rate.equals("1.35932")) System.out.println ("Trade Rate " + rate + " is correct");
        else System.out.println ("Trade Rate " + rate + " is incorrect");
        
        String baseamount = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[2]/td[2]")).getText();
        if (baseamount.equals("248,000.00")) System.out.println ("Base Amount " + baseamount + " is correct");
        else System.out.println ("Base Amount " + baseamount + " is incorrect");
        
        String termamount = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[2]/td[4]")).getText();
        if (termamount.equals("337,111.36")) System.out.println ("Term Amount " + termamount + " is correct");
        else System.out.println ("Term Amount " + termamount + " is incorrect");
        
        String tradeid = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[2]/td[6]")).getText();
        if (tradeid.equals("FXI1114579201")) System.out.println ("Trade ID " + tradeid + " is correct");
        else System.out.println ("Trade ID " + tradeid + " is incorrect");
        
        String counterparty = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[3]/td[2]")).getText();
        if (counterparty.equals("DB")) System.out.println ("Counterparty " + counterparty + " is correct");
        else System.out.println ("Counterparty " + counterparty + " is incorrect");
        
        String exectime = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[3]/td[4]")).getText();
        if (exectime.equals("2014-06-22 21:03:10.124")) System.out.println ("Execution TIme " + exectime + " is correct");
        else System.out.println ("Execution TIme " + exectime + " is incorrect");
        
        String orderid = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[3]/td[6]")).getText();
        if (orderid.equals("633433363")) System.out.println ("Order ID " + orderid + " is correct");
        else System.out.println ("Order ID " + orderid + " is incorrect");
        
        String spotrate = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[4]/td[2]")).getText();
        if (spotrate.equals("1.35932")) System.out.println ("Spot Rate " + spotrate + " is correct");
        else System.out.println ("Spot Rate " + spotrate + " is incorrect");
        
        String type = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[4]/td[4]")).getText();
        if (type.equals("FXSpot")) System.out.println ("Type " + type + " is correct");
        else System.out.println ("Type " + type + " is incorrect");
        
        String tradedate = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[4]/td[6]")).getText();
        if (tradedate.equals("2014-06-23")) System.out.println ("Trade Date " + tradedate + " is correct");
        else System.out.println ("Trade Date " + tradedate + " is incorrect");
        
        String tradestatus = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[5]/td[2]")).getText();
        if (tradestatus.equals("Failed")) System.out.println ("Trade Status " + tradestatus + " is correct");
        else System.out.println ("Trade Status " + tradestatus + " is incorrect");
        
        String usdamount = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[5]/td[4]")).getText();
        if (usdamount.equals("337,111.36")) System.out.println ("USD Amount " + usdamount + " is correct");
        else System.out.println ("USD Amount " + usdamount + " is incorrect");
        
        String organization = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[5]/td[6]")).getText();
        ...
        String matchedrate = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[6]/td[2]")).getText();
        if (matchedrate.equals("1.35932")) System.out.println ("Matched Rate " + matchedrate + " is correct");
        else System.out.println ("Matched Rate " + matchedrate + " is incorrect");
        
        String cptyaccount = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[6]/td[4]")).getText();
        if (cptyaccount.equals("DB-le1")) System.out.println ("Counterpaty Account " + cptyaccount + " is correct");
        else System.out.println ("Counterpaty Account " + cptyaccount + " is incorrect");
        
        String workflow = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[6]/td[6]")).getText();
        ...
        String stream = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[7]/td[2]")).getText();
        if (stream.equals("PRD010")) System.out.println ("Stream " + stream + " is correct");
        else System.out.println ("Stream " + stream + " is incorrect");
        
        String origcptyuser = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[7]/td[4]")).getText();
        if (origcptyuser.equals("API1")) System.out.println ("Originating Cpty User " + origcptyuser + " is correct");
        else System.out.println ("Originating Cpty User " + origcptyuser + " is incorrect");
        
        String valuedate = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[7]/td[6]")).getText();
        if (valuedate.equals("2014-06-25")) System.out.println ("Value Date " + valuedate + " is correct");
        else System.out.println ("Value Date " + valuedate + " is incorrect");
        
        String fixingdate = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[8]/td[2]")).getText();
        ...
        String salesdealeraccount = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[8]/td[4]")).getText();
        ...
        String salesdealeruser = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[8]/td[6]")).getText();
        ...
        String primebrokeracct = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[9]/td[2]")).getText();
        ...
        String pimebroker = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[9]/td[4]")).getText();
        ...
        String makerorg = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[9]/td[6]")).getText();
        if (makerorg.equals("DB")) System.out.println ("Maker Org " + makerorg + " is correct");
        else System.out.println ("Maker Org " + makerorg + " is incorrect");
        
        String virtualserver = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[10]/td[2]")).getText();
        if (virtualserver.equals("SUCD-Spaces-BA")) System.out.println ("Virtual Server " + virtualserver + " is correct");
        else System.out.println ("Virtual Server " + virtualserver + " is incorrect");
        
        String tkrrefid = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[10]/td[4]")).getText();
        if (tkrrefid.equals("628537657")) System.out.println ("Taker Ref ID " + tkrrefid + " is correct");
        else System.out.println ("Taker Ref ID " + tkrrefid + " is incorrect");
        
        String mkrrefid = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[10]/td[6]")).getText();
        if (mkrrefid.equals("-")) System.out.println ("Maker Ref ID " + mkrrefid + " is correct");
        else System.out.println ("Maker Ref ID " + mkrrefid + " is incorrect");
        
        String assettype = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[11]/td[2]")).getText();
        ...
        String ordertype = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[11]/td[4]")).getText();
        ...
        String classification = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[11]/td[6]")).getText();
        ...
        String extdealid = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[12]/td[2]")).getText();
        if (extdealid.equals("-")) System.out.println ("External Deal ID " + extdealid + " is correct");
        else System.out.println ("External Deal ID " + extdealid + " is incorrect");
        
        String extorderid = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[12]/td[4]")).getText();
        ...
        String cptyFI = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[12]/td[6]")).getText();
        if (cptyFI.equals("DB")) System.out.println ("Counter Party(FI) " + cptyFI + " is correct");
        else System.out.println ("Counter Party(FI) " + cptyFI + " is incorrect");
        
        String server = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[13]/td[2]")).getText();
        ...
        String fresherquote = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[13]/td[4]")).getText();
        ...
        String nextraterecvd = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[13]/td[6]")).getText();
        ...
        String stdreason = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[14]/td[2]")).getText();
        ...
        String historicrate = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[14]/td[4]")).getText();
        ...
        String nextrate = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[14]/td[6]")).getText();
        ...
        String clienttag = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[15]/td[2]")).getText();
        ...
        String orgLEI = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[15]/td[4]")).getText();
        ...
        String provLEI = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[15]/td[6]")).getText();
        ...
        String nettradeid = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[16]/td[2]")).getText();
        ...
        String portfolioid = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[16]/td[4]")).getText();
        if (portfolioid.equals("SUCD-Spaces-BA")) System.out.println ("Portfolio ID " + portfolioid + " is correct");
        else System.out.println ("Portfolio ID " + portfolioid + " is incorrect");
        
        String comment = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[16]/td[6]")).getText();
        if (comment.startsWith("Liquidity Regeneration in Progress, Trading")) System.out.println ("Comment " + comment + " is correct");
        else System.out.println ("Comment " + comment + " is incorrect");
        
        String UPI = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[17]/td[2]")).getText();
        if (UPI.equals("EUR_USD_SPOT")) System.out.println ("UPI " + UPI + " is correct");
        else System.out.println ("UPI " + UPI + " is incorrect");
        
        String USI = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[17]/td[4]")).getText();
        if (USI.equals("-")) System.out.println ("USI " + USI + " is correct");
        else System.out.println ("USI " + USI + " is incorrect");
        
        String UTI = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[17]/td[6]")).getText();
        if (UTI.equals("-")) System.out.println ("UTI " + UTI + " is correct");
        else System.out.println ("UTI " + UTI + " is incorrect");
        
        String channel = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[18]/td[2]")).getText();
        ...
        String dealer = driver.findElement(By.xpath("//body/div[1]/div[2]/table/tbody/tr[18]/td[4]")).getText();
        ...
        System.out.println("\nPanel Name:" + driver.findElement(By.xpath("//body/div[2]/div[1]")).getText());
        System.out.println("************************");
        
        String column1 = driver.findElement(By.xpath("//body/div[2]/div[2]/table/thead/tr/td[1]")).getText();
        ...
        String provrateused = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[6]/strong")).getText();
        if (provrateused.equals("1.35932")) System.out.println ("Provier Rate Used for Trade " + provrateused + " is highlighted");
                	        
        String provused = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[9]")).getText();
        if (provused.equals("DB3")) System.out.println ("Provier Used for Trade " + provused + " is highlighted");
                
        String usedratetimestmp = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[10]")).getText();
        if (usedratetimestmp.equals("2014-06-22 21:03:09.465")) System.out.println ("Timestamp of Rate Used " + usedratetimestmp + " is highlighted");
        
        String bid1timestamp = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[1]")).getText();
        if (bid1timestamp.equals("2014-06-22 21:03:46.820")) System.out.println ("Timestamp of Bid1 Rate " + bid1timestamp + " is correct");
        else System.out.println ("Timestamp of Bid1 Rate " + bid1timestamp + " is incorrect");
        
        String bid1provider = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[2]")).getText();
        if (bid1provider.equals("DB3")) System.out.println ("Provider of Bid1 Rate " + bid1provider + " is correct");
        else System.out.println ("Provider of Bid1 Rate " + bid1provider + " is incorrect");
        
        String bid1size = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[3]")).getText();
        if (bid1size.equals("390,000.00")) System.out.println ("Bid1 Size " + bid1size + " is correct");
        else System.out.println ("Bid1 Size " + bid1size + " is incorrect");
        
        String bid1tier = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[4]")).getText();
        ...
        String bid1rate = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[5]/strong")).getText();
        if (bid1rate.equals("1.3593")) System.out.println ("Bid1 Rate(Top of the book) " + bid1rate + " is correct");
        else System.out.println ("Bid1 Rate(Top of the book) " + bid1rate + " is incorrect");
        
        String offer1rate = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[6]/strong")).getText();
        if (offer1rate.equals("1.35932")) System.out.println ("Offer1 Rate(Top of the book) " + offer1rate + " is correct");
        else System.out.println ("Offer1 Rate(Top of the book) " + offer1rate + " is incorrect");
        
        String offer1tier = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[7]")).getText();
        ...
        String offer1size = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[8]")).getText();
        if (offer1size.equals("248,000.00")) System.out.println ("Offer1 Size " + offer1size + " is correct");
        else System.out.println ("Offer1 Size " + offer1size + " is incorrect");
        
        String offer1provider = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[9]")).getText();
        if (offer1provider.equals("DB3")) System.out.println ("Provider of Offer1 Rate " + offer1provider + " is correct");
        else System.out.println ("Provider of Offer1 Rate " + offer1provider + " is incorrect");
        
        String offer1timestamp = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[1]/td[10]")).getText();
        if (offer1timestamp.equals("2014-06-22 21:03:09.465")) System.out.println ("Timestamp of Offer1 Rate " + offer1timestamp + " is correct");
        else System.out.println ("Timestamp of Offer1 Rate " + offer1timestamp + " is incorrect");
        
        String bid2timestamp = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[2]/td[1]")).getText();
        if (bid2timestamp.equals("2014-06-22 21:02:46.820")) System.out.println ("Timestamp of Bid2 Rate " + bid2timestamp + " is correct");
        ...
        if (bid2provider.equals("DB3")) System.out.println ("Provider of Bid2 Rate " + bid2provider + " is correct");
        ...
        if (bid2size.equals("500,000.00")) System.out.println ("Bid2 Size " + bid2size + " is correct");
        ...
        if (bid2tier.equals("2")) System.out.println ("Bid2 Tier " + bid2tier + " is correct");
        ...
        if (bid2rate.equals("1.35929")) System.out.println ("Bid2 Rate(Top of the book) " + bid2rate + " is correct");
        ...
        if (offer2rate.equals("1.35936")) System.out.println ("Offer2 Rate(Top of the book) " + offer2rate + " is correct");
        ...
        if (offer2tier.equals("2")) System.out.println ("Offer2 Tier " + offer2tier + " is correct");
        ...
        if (offer2provider.equals("DB3")) System.out.println ("Provider of Offer2 Rate " + offer2provider + " is correct");
        ...
        if (offer2timestamp.equals("2014-06-22 21:02:46.820")) System.out.println ("Timestamp of Offer2 Rate " + offer2timestamp + " is correct");
        else System.out.println ("Timestamp of Offer2 Rate " + offer2timestamp + " is incorrect");
        
        String bid3timestamp = driver.findElement(By.xpath("//body/div[2]/div[2]/table/tbody/tr[3]/td[1]")).getText();
        if (bid3timestamp.equals("2014-06-22 21:03:04.195")) System.out.println ("Timestamp of Bid3 Rate " + bid3timestamp + " is correct");
        ...
        if (bid3provider.equals("UBS1")) System.out.println ("Provider of Bid3 Rate " + bid3provider + " is correct");
        ...
        if (bid3size.equals("1,000,000.00")) System.out.println ("Bid3 Size " + bid3size + " is correct");
        ...
        if (bid3rate.equals("1.35927")) System.out.println ("Bid3 Rate(Top of the book) " + bid3rate + " is correct");
        ...
        if (offer3rate.equals("1.35943")) System.out.println ("Offer3 Rate(Top of the book) " + offer3rate + " is correct");
        ...
        if (offer3tier.equals("3")) System.out.println ("Offer3 Tier " + offer3tier + " is correct");
        ...
        if (offer3size.equals("3,000,000.00")) System.out.println ("Offer3 Size " + offer3size + " is correct");
        ...
        if (offer3provider.equals("DB3")) System.out.println ("Provider of Offer3 Rate " + offer3provider + " is correct");
        ...
        if (offer3timestamp.equals("2014-06-22 21:02:46.820")) System.out.println ("Timestamp of Offer3 Rate " + offer3timestamp + " is correct");
        ...
        if (event2.equals("RateReceivedByAdapter (1.3593/1.35932)")) System.out.println ("Event2:: " + event2 + " is correct");
        ...
        if (event7.equals("RateAggregatedByServer")) System.out.println ("Event7:: " + event7 + " is correct");
        ...
        if (event8.equals("ClientSendAcceptance")) System.out.println ("Event8:: " + event8 + " is correct");
        ...
        if (event9.equals("OrderRecivedByServer")) System.out.println ("Event9:: " + event9 + " is correct");
        ...
        if (event10.equals("OrderMatchedByServer")) System.out.println ("Event10:: " + event10 + " is correct");
        ...
        if (event11.equals("AcceptanceSentByOA")) System.out.println ("Event11:: " + event11 + " is correct");
        ...
        if (event12.equals("RateAcceptedByServer")) System.out.println ("Event12:: " + event12 + " is correct");
        ...
        if (event13.equals("RejectedByIntegral")) System.out.println ("Event13:: " + event13 + " is correct");
        else System.out.println ("Event13:: " + event13 + " is incorrect");
                        
        String guidordmatchedevent = driver.findElement(By.xpath("//body/div[3]/div[2]/table/tbody/tr[10]/td[2]")).getText();
        if (guidordmatchedevent.equals("G-3c369d51-146c563c9fe-DBK-3-SUCD-DB3-105")) System.out.println ("GUID for OrderMatchedByServer event:: " + guidordmatchedevent + " is correct");
        else System.out.println ("GUID for OrderMatchedByServer event:: " + guidordmatchedevent + " is incorrect");
        
        String timestampordmatchedevent = driver.findElement(By.xpath("//body/div[3]/div[2]/table/tbody/tr[10]/td[3]")).getText();
        if (timestampordmatchedevent.equals("2014-06-22 21:03:10.124")) System.out.println ("Timestamp for OrderMatchedByServer event:: " + timestampordmatchedevent + " is correct");
        ...
        if (ctdealid.equals("FXI1103380901")) System.out.println ("Deal ID1 for Covered Trades:: " + ctdealid + " is correct");
        ...
        if (ctccypair.equals("EUR/USD")) System.out.println ("Ccy Pair1 for Covered Trades:: " + ctccypair + " is corerct");
        ...
        if (ctexectime.equals("2014-06-23 02:33:10.121")) System.out.println ("Execution Timestamp1 for Covered Trades:: " + ctexectime + " is correct");
        ...
        if (ctbaseamount.equals("441,000.00")) System.out.println ("Base Amount1 for Covered Trades:: " + ctbaseamount + " is correct");
        ...
        if (cttermamount.equals("599,504.22")) System.out.println ("Term Amount1 for Covered Trades:: " + cttermamount + " is correct");
        ...
        if (ctrate.equals("1.35942")) System.out.println ("Rate1 for Covered Trades:: " + ctrate + " is correct");
        ...
        if (ctbuysell.equals("Buy")) System.out.println ("Buy/Sell1 for Covered Trades:: " + ctbuysell + " is correct");
