...
public class EMScope_Login_MKTOrder  {
    public static void main(String[] args) {
    	System.out.println("######################################################################");
		System.out.println("EMSCOPE AUTOMATION TEST CASE 1\n");
		System.out.println("THIS TEST CASE VERIFIES CONTENT OF ORDER ID TAB FOR A GIVEN MARKET RANGE ORDER\n");
        ...
        if (chartcontent2.contains("FXI905425278C")) {        	
        ...
        for(WebElement option : list4){
            ...
            String Narratives = "CITIP Order ID: 543576781\nThe CITIP:CITIPQuoter placed a/an MARKET order to Sell USD/CAD @ Range 0.00008 from 1.08809 for an amount of 10,000,000 USD.\nTime in Force: GTD The order was placed at 12-05-2014 12:44:30.227, GMT\nIt got expired at 12-05-2014 12:45:04.336. The partially filled amount was 7500000 @ 1.0880222.";
        ...
        for(WebElement option : list5){
            ...
            if((k==7500000.0 && m==1.52E7) && (o==0.0 && q==0.0)) {
        ...
        for(WebElement option : list6){
            ...
            if(elements2[0].endsWith("584427598") && elements2[1].endsWith("543576781")) {
            	if(elements2[3].endsWith("1.08809") && elements2[4].endsWith("7500000")) {
            		if(elements2[5].endsWith("USD") && elements2[6].endsWith("10000000")) {
            			if(elements2[7].endsWith("10000000") && elements2[8].endsWith("Expired")) {
            				if(elements2[9].endsWith("CITIPQuoter") && elements2[10].endsWith("2014-05-12 12:44:30.227")) {
            					if(elements2[11].endsWith("1.0880222") && elements2[12].endsWith("GTD")) {
            						if(elements2[14].endsWith("75") && elements2[15].endsWith("CITIP")) {
            							if(elements2[16].endsWith("MARKET") && elements2[17].endsWith("10000000")) {
            								if(elements2[18].endsWith("Sell") && elements2[19].endsWith("USD/CAD")) {
            									if(elements2[20].endsWith("N") && elements2[22].endsWith("0.00008")) {
        ...
        for(WebElement option : list8){
            ...
            WebElement lasttrade = driver.findElement(By.xpath("//body/div/div/div[2]/div[2]/div[10]/div/div/div/div/div/div[4]/table/tbody/tr[10]/td/a"));
            WebElement lasttimestamp = driver.findElement(By.xpath("//body/div/div/div[2]/div[2]/div[10]/div/div/div/div/div/div[4]/table/tbody/tr[10]/td[2]"));
            
            if(elements3[0].equals("FXI905425278C") && elements3[4].equals("2014-05-12")) {
            	if(elements3[5].equals("12:44:30.465") && elements3[6].equals("1.08809")) {
            		if(elements3[7].equals("1000000") && elements3[8].equals("CHPT")) {
            			if(elements3[9].equals("StreamNY") && elements3[10].equals("Confirmed")) {
            				if(elements3[11].equals("Sell") && elements3[12].equals("FXSpot")) {
            					if(elements3[13].startsWith("CITIP") && elements3[117].endsWith("FXI905425275C")) {
            						if(elements3[121].equals("2014-05-12") && elements3[122].equals("12:44:30.465")) {
            							if(elements3[123].equals("1.0881") && elements3[124].equals("500000")) {
            								if(elements3[125].equals("KMDO") && elements3[126].equals("Stream1")) {
            									if(elements3[127].equals("Confirmed") && elements3[128].equals("Sell")) {
            										if(elements3[129].equals("FXSpot") && elements3[130].startsWith("CITIP")) {
            											if(elements3[135].equals("30")){
            												if(lasttrade.getText().equals("FXI905425323C") && lasttimestamp.getText().equals("2014-05-12 12:44:31.520")){
        ...
        for(WebElement option : list9){
            ...
            WebElement lastbenchmark = driver.findElement(By.xpath("//body/div/div/div[2]/div[2]/div[10]/div/div/div[2]/div/div/div[4]/table/tbody/tr[3]/td"));
            WebElement lasttimestamp2 = driver.findElement(By.xpath("//body/div/div/div[2]/div[2]/div[10]/div/div/div[2]/div/div/div[4]/table/tbody/tr[3]/td[2]"));
            
            if(elements4[0].equals("2014-05-12") && elements4[1].equals("12:44:30.000")) {
            	if(elements4[2].equals("1.08813875") && elements4[3].startsWith("0.425")) {
            		if(elements4[6].endsWith("2014-05-12") && elements4[7].equals("12:44:32.000")) {
            			if(elements4[8].equals("1.0880175") && elements4[9].startsWith("0.975")) {
            				if(elements4[14].equals("3")){
            					if(lastbenchmark.getText().equals("2014-05-12 12:44:32.000") && lasttimestamp2.getText().equals("1.0880175")) {
        ...
        for(WebElement option : list10){
            ...
            WebElement lasttimestamp3 = driver.findElement(By.xpath("//body/div/div/div[2]/div[2]/div[10]/div/div/div[3]/div/div/div[4]/table/tbody/tr[8]/td"));
            WebElement lastrateguid = driver.findElement(By.xpath("//body/div/div/div[2]/div[2]/div[10]/div/div/div[3]/div/div/div[4]/table/tbody/tr[8]/td[7]"));
                                    
            if(elements5[0].equals("2014-05-12") && elements5[1].equals("12:44:30.000")) {
            	if(elements5[2].equals("1.08821") && elements5[3].equals("2000000")) {
            		if(elements5[4].equals("1.0881") && elements5[5].equals("1000000")) {
            			if(elements5[6].equals("Active") && elements5[7].equals("G-3c369d87-145f0768094-CFSSA-55f95")) {
            				if(elements5[8].startsWith("1") && elements5[9].equals("12:44:30.000")) {
            					if(elements5[10].equals("1.08822") && elements5[11].equals("10000000")) {
            						if(elements5[12].equals("1.08808") && elements5[13].equals("2000000")) {
            							if(elements5[14].equals("Active") && elements5[15].equals("G-3c369d87-145f0768094-CFSSA-55f95")) {
            								if(elements5[16].startsWith("2") && elements5[17].equals("12:44:30.000")) {
            									if(elements5[18].equals("1.08823") && elements5[19].equals("10300000")) {
            										if(elements5[20].equals("1.08807") && elements5[21].equals("2700000")) {
            											if(elements5[22].equals("Active") && elements5[23].equals("G-3c369d87-145f0768094-CFSSA-55f95")) {
            											if(elements5[24].startsWith("3")){
            												if(lasttimestamp3.getText().equals("2014-05-12 12:44:31.962") && lastrateguid.getText().equals("G-3c369d87-145f0768b5a-CFSSA-560b2")){
        ...
        for(WebElement option : list11){
            ...
            int querytime4 = Integer.parseInt(Tick_Data_Query);            
