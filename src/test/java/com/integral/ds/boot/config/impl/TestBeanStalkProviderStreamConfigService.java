 ...
 */
public class TestBeanStalkProviderStreamConfigService {

    //@Test
    public void testBeansTalksProviderStreamComfig() throws Exception {
        ...
        BeanStalkProviderStreamConfigServiceImpl awsService = new BeanStalkProviderStreamConfigServiceImpl();
